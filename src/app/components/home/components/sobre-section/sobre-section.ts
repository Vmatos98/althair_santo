...
export class SobreSection {
  ...
  sobreData = {
    ...
    description: 'Quando se olha para o trabalho de Althair Santo, a força criativa sergipana aparece de imediato. Formado em Design de moda pela faculdade do Centro de Tecnologia da Indústria Quite Textil do Cetiqt do Rio de Janeiro e em Português/Francês pela UFS, ele enxerga a moda como linguagem e obra de arte.  Um caminho para contar histórias e valorizar o território que o formou.',
